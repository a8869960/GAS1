...
struct initial_conditions_t
{
  ...
  double (*m_rho_0)(double) = nullptr;         // rho_0 (x)
  double (*m_u_0)(double) = nullptr;           // u_0 (x)
  ...
  double rho_0 (const double x) const { return m_rho_0 (x); }
  double u_0 (const double x) const { return m_u_0 (x); }
