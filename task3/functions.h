...
inline double rho_0_first (const double x, const unsigned int k)
{
  return 2. + sin (k * M_PI * x);
}
inline double u_0_first (const double /*x*/, const unsigned int /*k*/) { return 0.; }

inline double rho_0_second (const double /*x*/, const unsigned int /*k*/) { return 1.; }
inline double u_0_second (const double x, const unsigned int k)
{
  return sin (k * M_PI * x);
}
